...
export type Confederacion = "UEFA" | "CONMEBOL" | "CONCACAF" | "CAF" | "AFC";
...
export type CompeticionTipo = "domestica" | "internacional" | "seleccion";
export type CompeticionCategoria = "liga" | "copa" | "primerNivel" | "segundoNivel" | "mundial" | "continental";

export interface Competicion {
  id: string;
  nombre: string;
  tipo: CompeticionTipo;
  categoria: CompeticionCategoria;
  ligaId?: string;
  confederacion?: Confederacion | null;
  trofeoImagen: string;
  partidosMinimos: number;
  partidosExtra: number;
}

interface GameDatabaseShape {
  ligas: Liga[];
...
export const GameDatabase: GameDatabaseShape = {
  ligas: [
